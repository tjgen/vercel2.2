    ...
    [507], {
        74011: (t, e, i) => {
            ...
            class p extends d.MediaCoordinatesPaneRenderer {
                constructor(t) {
                    super(), this._data = null, this._backHittest = new o.HitTestResult(o.HitTarget.MovePointBackground), this._points = [], this._hittest = null != t ? t : new o.HitTestResult(o.HitTarget.MovePoint)
                }
                setData(t) {
        ...
        55269: (t, e, i) => {
            ...
            class o {
                ...
                drawBackground(t, e) {
                    ...
                    (0,
                        n.fillRect)(t, r, 0, o - r, e.bitmapSize.height, s)
                }
            }
            class l {
                constructor(t, e, i) {
                ...
                _updateViewInternal() {
                    ...
                    i.forEach(((t, i) => {
                        ...
                        t.forEach((t => {
                            ...
                            d === i - 1 && (h = l || h), l = c, d = o, h < 0 && c < 0 || h > e.width() && c > e.width() || this._data.push({
                                x1: h,
                                x2: c,
                                color: r.color.value(),
        ...
        56208: (t, e, i) => {
            ...
            class p {
                    ...
                    for (const s of i.histograms) {
                        ...
                        for (const a of s.bars) {
                            ...
                            for (let e = 0; e < a.subBarValues.length; e++) {
                                ...
                                if (p = o, (t.x >= n && t.x <= o || t.x >= o && t.x <= n) && t.y >= i && t.y <= s) return new d.HitTestResult(d.HitTarget.Regular)
                            }
                        }
                    }
                    return null
                ...
                draw(t, e) {
                    ...
                    t.save(), i.histograms.forEach((a => {
                        ...
                        if (x >= 7.5)
                            for (const i of p) i.fontSize = x, m(t, e, i)
                    })), t.restore()
                }
            }
            ...
            function g(t, e, i, s, r, a) {
                ...
                }(t, i, a), h = r.direction === n.HHistDirection.LeftToRight ? "left" : "right", {
                    xBasePoint: c,
                    sign: u
                } = s, f = c + 3 * u, p = e + d;
                return {
            ...
            class w {
                ...
                _prepareStyles() {
                    ...
                    const i = (0, r.ensureDefined)(this._provider.graphicsInfo().hhists),
                        ...
                        o = (null === (e = null === (t = this._provider.properties().child("inputs")) || void 0 === t ? void 0 : t.child("volume")) || void 0 === e ? void 0 : e.value()) === n.HHistVolumeMode.Delta;
                    for (const t of s) {
                        const e = (0, r.ensureDefined)(a.childs()[t]).childs(),
                            s = (0, r.ensureDefined)(i[t]);
                        if (o) this._rendererData.styles[t + "UpDominate"] = {
                ...
                _updateDataForRenderers(t, e, i) {
                    ...
                    const d = (null === (a = null === (s = this._provider.properties().child("inputs")) || void 0 === s ? void 0 : s.child("volume")) || void 0 === a ? void 0 : a.value()) === n.HHistVolumeMode.Delta,
                        h = function(t, e, i) {
                    ...
                    })), f.sort(((t, e) => t.y - e.y)), this._rendererData.histograms.push({
                        xRange: h,
