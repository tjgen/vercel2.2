    ...
    [6014], {
        ...
        27267: (e, t, i) => {
            ...
            function n(e, t, i, n, o) {
                ...
                return o.click && n.addEventListener("click", s, !1), o.mouseDown && n.addEventListener("mousedown", s, !1), o.touchEnd && n.addEventListener("touchend", s, !1), o.touchStart && n.addEventListener("touchstart", s, !1), () => {
        ...
        36383: (e, t, i) => {
            ...
            function a(e) {
                const {
                    ...
                    handler: l,
                    reference: d
                } = e, u = (0, n.useRef)(null), c = (0, n.useRef)("undefined" == typeof window ? 0 : new window.CustomEvent("timestamp").timeStamp);
            ...
            function d(e) {
                ...
                if (e && 1 == ++r) {
                    const e = s(t, "overflow"),
                        r = a(t, "padding-right");
                    "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (o(i, "right", `${n()}px`), t.style.paddingRight = `${r+n()}px`, l = !0), t.classList.add("i-no-scroll")
        ...
        82206: (e, t, i) => {
            ...
            class u extends n.PureComponent {
                constructor() {
                    super(...arguments), this._manager = new r.OverlapManager, this._handleSlot = e => {
                ...
                render() {
                    ...
                    } = this.props, h = o(r, d.dialog, e && d.rounded, t && d.shadowed, i && d.fullscreen, s && d.darker), g = (0, l.filterDataProps)(this.props), _ = this.props.style ? { ...this._createStyles(),
                        ...this.props.style
                    } : this._createStyles();
                    return n.createElement(n.Fragment, null, n.createElement(a.SlotContext.Provider, {
                        value: this._manager
                    }, u && n.createElement("div", {
                        onClick: this.props.onClickBackdrop,
                        className: d.backdrop
                    }), n.createElement("div", { ...g,
                        className: h,
                        style: _,
                        ref: this.props.reference,
                    ...
                    }, this.props.children)), n.createElement(a.Slot, {
            ...
            class w {
                constructor(e, t, i = {
                    ...
                    this._drag = null, this._canBeTouchClick = !1, this._frame = null, this._onMouseDragStart = e => {
                        ...
                        this._canBeTouchClick = !0,
                            e.preventDefault(), this._header.addEventListener("touchmove", this._onTouchDragMove, {
                                passive: !1
                            });
                        const t = f(y(e));
                        this._dragStart(t)
                ...
                _dragStart(e) {
                    ...
                    const i = Math.round(t.left),
                        n = Math.round(t.top);
                    this._dialog.style.transform = `translate(${i}px, ${n}px)`, this._header.classList.add("dragging"), this._options.onDragStart && this._options.onDragStart()
                }
                _dragMove(e) {
                    if (this._drag) {
            ...
            const k = class {
                ...
                centerAndFit() {
                    const {
                        x: e,
                        y: t
                    } = this.getDialogsTopLeftCoordinates(), i = this._calcAvailableHeight(), n = this._calcDialogHeight();
                    if (i === n)
                ...
                getDialogsTopLeftCoordinates() {
                    const {
                        clientWidth: e,
                        clientHeight: t
                    } = this._getClientDimensions(), i = this._calcDialogHeight(), n = e / 2 - this._dialog.clientWidth / 2, o = t / 2 - i / 2 + this._getTopOffset();
                    return {
                        x: Math.round(n),
                        y: Math.round(o)
                    }
                ...
                recalculateBounds() {
                    ...
                    const {
                        ...
                        vertical: n
                    } = this._guard, o = null === (e = this._calculateDialogPosition) || void 0 === e ? void 0 : e.call(this, this._dialog, {
                        clientWidth: t,
                        clientHeight: i
                    }, {
                        vertical: n
                    ...
                    if (this._isFullscreen) {
                        ...
                        this._dialog.style.top = "0px", this._dialog.style.left = "0px", this._dialog.style.transform = `translate(${Math.round(s)}px, ${Math.round(a)}px)`, this._dialog.style.height = o < e.height ? o + "px" : this._initialHeight
                    }
                }
                destroy() {
            ...
            class L extends n.PureComponent {
                constructor(e) {
                    super(e), this._dialog = null, this._cleanUpFunctions = [], this._prevActiveElement = null, this._eventDispatcher = new A, this._handleDialogRef = e => {
                        const {
                            reference: t
                        } = this.props;
                ...
                render() {
                    return n.createElement(D.PopupContext.Provider, {
                        value: this
                    }, n.createElement(g.OutsideEvent, {
                        mouseDown: !0,
                        touchStart: !0,
                        ...
                        className: o(P.dialog, (0, F.isOnMobileAppPage)("any") && !this.props.noMobileAppShadows && P.mobile, this.props.fullscreen && P.fullscreen, this.props.className)
                ...
                componentDidMount() {
                    const {
                        ...
                        boundByScreen: t,
                        onDragStart: i
                    } = this.props, n = (0, s.ensureNotNull)(this._dialog);
                    ...
                    this.props.autofocus && !n.contains(document.activeElement) && n.focus(), (this._isFullScreen() || this.props.fixedBody) && (0, S.setFixedBodyState)(!0);
                    const {
                        guard: o,
                ...
                componentWillUnmount() {
                    ...
                    (this._isFullScreen() || this.props.fixedBody) && (0, S.setFixedBodyState)(!1), this._isFullScreen() && this._eventDispatcher.dispatch("dialog-fullscreen-off"), this._eventDispatcher.dispatch("dialog-close")
                }
                focus() {
                ...
                _applyAppearanceAnimation(e) {
                    if (this._resize && this._dialog) {
                        ...
                        this._dialog.style.setProperty("--animationTranslateStartX", `${t}px`), this._dialog.style.setProperty("--animationTranslateStartY", `${i}px`), this._dialog.style.setProperty("--animationTranslateEndX", `${n}px`), this._dialog.style.setProperty("--animationTranslateEndY", `${o}px`), this._dialog.classList.add(P.dialogAnimatedAppearance)
                    }
                }
                _handleTooltipFit() {
                    0
            ...
            L.contextType = x.PortalContext, L.defaultProps = {
                boundByScreen: !0,
                draggable: !0,
                centeredOnMount: !0,
                shouldReturnFocus: !0
            ...
            function s(e, t) {
                return class extends n.PureComponent {
                    render() {
                        ...
                        return "parent" === s ? a : n.createElement(o.Portal, {
                            shouldTrapFocus: t
                        }, a)
                    }
                }
        ...
        42842: (e, t, i) => {
            ...
            class l extends n.PureComponent {
                ...
                render() {
                    ...
                    e.style.top = this.props.top || "", e.style.bottom = this.props.bottom || "",
                        e.style.left = this.props.left || "", e.style.right = this.props.right || "", e.style.pointerEvents = this.props.pointerEvents || "";
                    const t = this.props.className;
                    return t && ("string" == typeof t ? e.classList.add(t) : e.classList.add(...t)), this.props.shouldTrapFocus && !e.hasAttribute("data-focus-trap") && e.setAttribute("data-focus-trap", "true"), this.props["aria-hidden"] && e.setAttribute("aria-hidden", "true"), o.createPortal(n.createElement(d.Provider, {
                        value: this
