    ...
    [3504], {
        ...
        39416: (e, t, o) => {
            ...
            function l(e) {
                const t = (0, n.useMemo)((() => function(e) {
                    ...
                    a = (0, n.useRef)(l);
                return a.current = l, (0, i.useIsomorphicLayoutEffect)((() => {
        ...
        27267: (e, t, o) => {
            ...
            function n(e, t, o, n, i) {
                ...
                return i.click && n.addEventListener("click", l, !1), i.mouseDown && n.addEventListener("mousedown", l, !1), i.touchEnd && n.addEventListener("touchend", l, !1), i.touchStart && n.addEventListener("touchstart", l, !1), () => {
        ...
        36383: (e, t, o) => {
            ...
            function r(e) {
                const {
                    ...
                    handler: s,
                    reference: c
                } = e, d = (0, n.useRef)(null), h = (0, n.useRef)("undefined" == typeof window ? 0 : new window.CustomEvent("timestamp").timeStamp);
            ...
            function c(e) {
                ...
                if (e && 1 == ++a) {
                    const e = l(t, "overflow"),
                        a = r(t, "padding-right");
                    "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (i(o, "right", `${n()}px`), t.style.paddingRight = `${a+n()}px`, s = !0), t.classList.add("i-no-scroll")
        ...
        59369: (e, t, o) => {
            ...
            function c(e) {
                ...
                return (0, n.useLayoutEffect)((() => {
                    const e = (0, i.ensureNotNull)(t.current),
                        o = () => {
                            ...
                            if (0 === o.length || o[0].parentElement && !u(o[0].parentElement, (0, i.ensureNotNull)(t.current))) {
                                const n = function(e) {
                                    const o = h(e).sort(l.navigationOrderComparator).find((e => u(e, (0, i.ensureNotNull)(t.current))));
                                    if (!o) return null;
                    ...
                    } else a = (u = i, Array.from(u.querySelectorAll("button:not([disabled]):not([aria-disabled])")).filter((0, l.createScopedVisibleElementFilter)(u))).sort(l.navigationOrderComparator), c = a.indexOf(n);
                    var u;
        ...
        16396: (e, t, o) => {
            ...
            function u(e) {
                const {
                    ...
                    trackRightClick: J,
                    ...U
                } = e, G = (0, n.useRef)(null), $ = (0, n.useMemo)((() => function(e) {
                    function t(t) {
                        const {
                            reference: o,
                            ...i
                        } = t, l = null != e ? e : i.href ? "a" : "div", r = "a" === l ? i : function(e) {
                            const {
                                download: t,
                                href: o,
                                hrefLang: n,
                ...
                return n.createElement(X, { ...U,
                    ...
                    onClick: function(e) {
                        ...
                        j && j(Q, e);
                        Z || (e.currentTarget.dispatchEvent(new CustomEvent("popup-menu-close-event", {
                            bubbles: !0,
                            detail: {
                                clickType: (0, s.isKeyboardClick)(e) ? "keyboard" : "mouse"
                            }
                        })), (0, r.globalCloseMenu)())
                    },
                    ...
                    onKeyDown: N,
                    tabIndex: I
                }, B && n.createElement(a.CircleLogo, { ...O,
                    ...
                    className: i(K.label, g)
                }, z)), (void 0 !== f || p) && n.createElement("span", {
                    className: K.shortcut
                }, (Y = f) && Y.split("+").join(" + ")), void 0 !== P && n.createElement("span", {
                    onClick: _ ? h : void 0,
        ...
        42842: (e, t, o) => {
            ...
            class s extends n.PureComponent {
                ...
                render() {
                    ...
                    return t && ("string" == typeof t ? e.classList.add(t) : e.classList.add(...t)), this.props.shouldTrapFocus && !e.hasAttribute("data-focus-trap") && e.setAttribute("data-focus-trap", "true"), this.props["aria-hidden"] && e.setAttribute("aria-hidden", "true"), i.createPortal(n.createElement(c.Provider, {
                        value: this
        ...
        10838: (e, t, o) => {
            ...
            function d(e) {
                const {
                    className: t,
                    ...o
                } = e, [i, d] = (0, a.useRovingTabindexElement)(null);
                return n.createElement(s.PopupMenuItem, { ...o,
        ...
        29835: (e, t, o) => {
            ...
            const a = (0, n.forwardRef)(((e, t) => {
                ...
                return n.createElement(L, {
                    ...
                    className: m.bg
                }, d && ("string" == typeof d ? n.createElement(l.Icon, {
                    className: m.icon,
                    icon: d
                }) : n.createElement("span", {
                    className: m.icon
        ...
        2627: (e, t, o) => {
            ...
            const u = (0, d.humanReadableModifiers)(d.Modifiers.Shift, !1),
                ...
                m = {
                    keys: [u],
                    text: i.t(null, void 0, o(23369))
                },
                f = {
                    keys: [u],
                    text: i.t(null, void 0, o(13798))
                },
                p = {
                    keys: [u],
            ...
            ! function(e) {
                function t() {
                    ...
                    if (0 === d.length && c && "undefined" != typeof window) {
                        const e = JSON.parse(null !== (n = null === (t = window.urlParams) || void 0 === t ? void 0 : t.favorites) && void 0 !== n ? n : "{}").drawingTools;
                        e && Array.isArray(e) && d.push(...e)
                    }
                    d.forEach(((t, n) => {
                        const i = t.tool || t;
                        o(i) ? r.includes(i) ? s = !0 : e.favorites.push(i) : a && a.includes(i) && e.hiddenToolsPositions.set(i, n)
                    })), s && i(), e.favoritesSynced.fire()
                }
                ...
                e.favorites = [], e.favoritesSynced = new n.Delegate, e.hiddenToolsPositions = new Map, e.favoriteIndex = function(t) {
                    return e.favorites.indexOf(t)
                }, e.isValidLineToolName = o, e.saveFavorites = i, t(), l.onSync.subscribe(null, t)
            }(s || (s = {})),
            function(e) {
                function t(e) {
                ...
                e.favoriteAdded = new n.Delegate, e.favoriteRemoved = new n.Delegate,
                    e.favoriteMoved = new n.Delegate, e.favoritesSynced = s.favoritesSynced, e.favorites = function() {
                        return s.favorites.slice()
                    }, e.isValidLineToolName = t, e.favoritesCount = o, e.favorite = function(e) {
                        ...
                        return i.forEach(((e, t) => {
                            e > n && i.set(t, e - 1)
                        })), s.saveFavorites(o), e.favoriteRemoved.fire(t), !0
                    }, e.isFavorite = i, e.moveFavorite = function(n, i, l) {
                        ...
                        })), s.favorites.splice(r, 1), s.favorites.splice(i, 0, n), s.saveFavorites(l), e.favoriteMoved.fire(n, r, i), !0
                    }
            }(c || (c = {}))
        },
        52459: e => {
