    ...
    [7260], {
        ...
        23829: (e, t, n) => {
            ...
            function p(e) {
                const {
                    ...
                    jsxLabel: B,
                    size: w = "normal"
                } = e, T = (0, s.useContext)(l.EmptyIconsContext), W = !!S.length;
                return i ? s.createElement("li", {
                    className: a()(t, m.item, m.loading, m[w])
                }, s.createElement(r.Loader, null)) : s.createElement("li", {
                    className: a()(t, m.item, m.interactive, n && m.title, v && m.disabled, p && m.hovered, g && m.active, T && m.emptyIcons, m[w]),
                    onClick: M
                    ...
                    key: n,
                    style: t
                }, e))) : null != B ? B : y), !!R && s.createElement(o.Icon, {
                    onClick: function() {
                        R && R.action()
                    },
                    className: m.remove,
                    icon: u
                }), !W && x && s.createElement(c.Hint, {
                    className: m.shortcut,
                    text: x
                }), W && s.createElement(o.Icon, {
                    className: m.nested,
                    icon: d
                }), k)
            }
        ...
        6190: (e, t, n) => {
            ...
            const d = (0, s.forwardRef)((function(e, t) {
                ...
                }), []), s.createElement("div", { ...h.MouseClickAutoBlurHandler.attributes(m),
                    ...p,
                    role: "toolbar",
                    "aria-orientation": d,
                    ref: g,
        ...
        68426: (e, t, n) => {
            ...
            function B(e) {
                const t = function(e) {
                        ...
                        if (s.isWeeks()) return (e => a.t(null, {
                            plural: "{str} weeks",
                            count: e,
                            replace: {
                                str: `${e}`
            ...
            class T {
                constructor(e) {
                    this._state = {
                        ranges: []
                    }, this._change = new C.Delegate, this._rangeChangedListenerBound = this._onRangeChanged.bind(this), this._updateAvailableRangesBound = this._updateAvailableRanges.bind(this, void 0);
                    const {
                        chartWidget: t
                    } = this._context = e;
                    t.withModel(null, (() => {
                        const e = t.model(),
                            n = e.mainSeries();
                        n.onStatusChanged().subscribe(this, this._updateAvailableRanges), c.enabled("update_timeframes_set_on_symbol_resolve") && n.dataEvents().symbolResolved().subscribe(this, this._updateAvailableRangesBound), n.priceScale().properties().childs().lockScale.subscribe(this, this._updateAvailableRangesBound);
                ...
                destroy() {
                    ...
                    e.withModel(null, (() => {
                        const t = e.model(),
                            n = t.mainSeries();
                        n.onStatusChanged().unsubscribe(this, this._updateAvailableRanges), c.enabled("update_timeframes_set_on_symbol_resolve") && n.dataEvents().symbolResolved().unsubscribe(this, this._updateAvailableRangesBound), n.priceScale().properties().childs().lockScale.unsubscribe(this, this._updateAvailableRangesBound), t.model().appliedTimeFrame().unsubscribe(this._rangeChangedListenerBound)
                ...
                return (t = class extends s.PureComponent {
                    constructor(e, t) {
                        super(e, t), this._handleUpdate = e => {
                            ...
                            var t, n;
                            (0, v.trackEvent)("GUI", "Chart Bottom Toolbar", `range ${e.value}`), null === (n = (t = this.props).onSelectRange) || void 0 === n || n.call(t, e), this._binding.selectRange(e)
            ...
            function I(e) {
                ...
                return s.createElement(s.Fragment, null, t.map((e => s.createElement(z.ContextMenuItem, {
                    key: e.value.value,
            ...
            function X(e) {
                ...
                return s.createElement(s.Fragment, null, s.createElement(F.Separator, {
            ...
            class j extends s.PureComponent {
                constructor(e, t) {
                    super(e, t), this._handleGoToDateClick = () => {
                        ...
                        return e ? s.createElement(s.Fragment, null, s.createElement(I, {
                            ranges: t,
                            activeRange: n,
                ...
                render() {
                    ...
                    }, (e => s.createElement(h.ToolbarMenuButton, {
            ...
            function Y(e) {
                ...
                return s.createElement(Z.ToolbarButton, { ...h,
                    ref: t,
                    text: n,
                    isActive: a,
                    tooltip: i,
            ...
            const ne = q((function(e) {
                return s.createElement("div", {
                    className: r(e.className, ee.slider),
                    ref: e.reference
                }, s.createElement("div", {
                    className: ee.inner
                }))
            ...
            const se = A((function(e) {
                ...
                return s.createElement(ne, {
                    className: r(te.sliderRow, t),
                    "data-name": "date-ranges-tabs"
                }, n.map((e => s.createElement(Y, {
                    key: e.value.value,
                    value: e.value.value,
            ...
            class Ee extends s.PureComponent {
                constructor(e, t) {
                    super(e, t), this._timeFormatter = new ge.TimeFormatter((0, _e.getHourMinuteSecondFormat)(Ce.timeHoursFormatProperty.value())), this._tickInterval = void 0, this._element = null, this._menuShown = !1, this._preventShowingMenu = !1, this._tickClock = () => {
                            const {
                                chartApiInstance: e
                            } = this.context;
                        ...
                        this._getActions = () => {
                            ...
                            fe.ContextMenuManager.showMenu(n, {
                                clientX: s.left,
                                clientY: s.top,
                                attachToYBy: "bottom"
                            }, {
                ...
                componentDidMount() {
                    ...
                    this._tickInterval = setInterval(this._tickClock, 1e3), e.withModel(null, (() => {
                        const t = e.model();
                        t.model().mainSeries().dataEvents().symbolResolved().subscribe(this, this.updateTimezonesButton), t.model().properties().childs().timezone.subscribe(this, this.updateTimezonesButton), Ce.timeHoursFormatProperty.subscribe(this, this._timeHoursFormatPropertyChanged)
                    }))
                }
                componentWillUnmount() {
                    const {
                    ...
                    clearInterval(this._tickInterval), e.withModel(null, (() => {
                        const t = e.model();
                        t.model().mainSeries().dataEvents().symbolResolved().unsubscribe(this, this.updateTimezonesButton), t.model().properties().childs().timezone.unsubscribe(this, this.updateTimezonesButton), Ce.timeHoursFormatProperty.unsubscribe(this, this._timeHoursFormatPropertyChanged)
                    }))
                }
                render() {
                    const {
                        ...
                        time: i
                    } = this.state, o = void 0 !== this._timezone ? (0, pe.parseTzOffset)(this._timezone.name()).string : null;
                ...
                _timeHoursFormatPropertyChanged() {
                    this._timeFormatter = new ge.TimeFormatter((0, _e.getHourMinuteSecondFormat)(Ce.timeHoursFormatProperty.value())), this.updateTimezonesButton()
                }
            }
            Ee.contextType = ye;
            var Me = n(19615);
            ...
            class Je extends s.PureComponent {
                ...
                render() {
                    ...
                    return s.createElement(h.ToolbarMenuButton, {
                        arrow: !1,
                        isDisabled: !t,
                        content: n,
                        className: e,
                ...
                _menuItems() {
                    ...
                    const n = e.model().mainSeries(),
                        i = [s.createElement(Ie.ToolWidgetMenuSummary, {
                            key: "header_menu_text",
                            className: Oe.headerMenuText
            ...
            var Qe, et;
            ! function(e) {
                e.Separator = "separator", e.TimeZones = "timeZones", e.SessionId = "session", e.Percentage = "percentage", e.Logarithm = "logarithm", e.Auto = "auto", e.Fullscreen = "fullscreen", e.Adj = "adj", e.BackAdj = "backAdj", e.SettlementAsClose = "settlementAsClose", e.PreventPhoneLayout = "preventPhoneLayout"
            }(Qe || (Qe = {})),
            function(e) {
                e.Expanded = "expanded", e.Collapsed = "collapsed", e.Hidden = "hidden"
            }(et || (et = {}));
            const tt = (nt = e => s.createElement(Z.ToolbarButton, {
                text: Ye.logLabel,
                tooltip: Ye.logHint,
                ...
                render() {
                    ...
                    return s.createElement(nt, { ...this._priceAxisHighlighter.handlers(),
                        className: e,
                        isLogarithm: t,
                        isDisabled: null === n,
            ...
            class gt extends s.PureComponent {
                constructor(e, t) {
                    var n, a;
                    super(e, t), this._timezoneButtonRef = null, this._layout = Object.assign({}, mt), this._raf = null, this._toolbar = null, this._rangeExpanded = null, this._rangeCollapsed = null, this._seriesComponents = {}, this._resizeObserver = null, this._injector = (n = () => this._layout, a = (e, t) => this._seriesComponents[t] = e, (e, t, i) => {
                        ...
                        const {
                            chartWidget: t
                        } = this.context, n = t.model().model(), s = n.mainSeries(), i = s.symbolInfo(), a = !s.isDWMProperty().value();
                        ...
                        const e = this._layout,
                            ...
                            n = (0,
                                b.ensureNotNull)(this._rangeExpanded),
                            s = (a = function(e) {
                                const t = {};
                        ...
                        if (Object.assign(e, {
                            ...
                            let n = 0,
                                i = 0;
                            for (const a of s) n += a.width, a.name in lt ? (i += a.width, Object.assign(e, {
                                [a.name]: !1
                            })) : Object.assign(e, {
                                [a.name]: t <= n
                            });
                ...
                componentDidMount() {
                    ...
                    e.subscribe(this, this._resizeByRaf), t.fullscreenable.subscribe(this._handleFullscreenableChange), s.withModel(null, (() => {
                        const e = s.model(),
                            t = e.model();
                ...
                componentWillUnmount() {
                    ...
                    t.unsubscribe(this, this._resizeByRaf),
                        n.fullscreenable.unsubscribe(this._handleFullscreenableChange), null === (e = this._resizeObserver) || void 0 === e || e.disconnect(), i.withModel(null, (() => {
                            const e = i.model(),
                                t = e.model();
                ...
                render() {
                    ...
                    return s.createElement(Re.Toolbar, {
                        ...
                        className: Ke.dateRange
                    }), this.props.goToDateEnabled && s.createElement(ke, {
                        className: r(Ke.separator)
                    }), this.props.goToDateEnabled && s.createElement(ue, null)))), s.createElement("div", {
                    ...
                    }, s.createElement(ke, null)), s.createElement(He.FragmentMap, {
                        map: this._injector
                    }, !1, !1, !1, i && !c.enabled("fundamental_widget") && s.createElement(at, {
                        className: Ke.item
                    }), a && s.createElement(tt, {
                        className: Ke.item
                    }), o && s.createElement(it, {
                        className: Ke.item
                    }), l && this.state.isFullscreenable && s.createElement(rt, {
                        className: Ke.item,
                ...
                _setStateWithResize(e, t) {
                    Object.assign(this._layout, mt), this._applyResizing(), t ? (this.setState(e), this._resizeHandler()) : this.setState(e, (() => this._resizeByRaf()))
                }
                _applyResizing() {
                    const {
                        dateRangeMode: e,
                    ...
                    this._rangeExpanded && (this._rangeExpanded.classList.toggle(Ke.collapsed, "expanded" !== e), this._rangeExpanded.classList.toggle(Ke.noranges, t)), this._rangeCollapsed && this._rangeCollapsed.classList.toggle(Ke.collapsed, "collapsed" !== e);
                    let s = !1,
                        i = !1;
