(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [2157], {
                    ...
                    if (s) {
                        ...
                        if (e && !r.some((function(t) {
                            ...
                            r = [].concat(t(r), [h]), e.ontouchstart = function(e) {
                                ...
                                var n, o, s, r;
                                1 === t.targetTouches.length && (o = e, r = (n = t).targetTouches[0].clientY - i, !u(n.target) && (o && 0 === o.scrollTop && 0 < r || (s = o) && s.scrollHeight - s.scrollTop <= s.clientHeight && r < 0 ? d(n) : n.stopPropagation()))
        ...
        5811: (e, t, n) => {
            ...
            function c(e) {
                const {
                    ...
                    hideIcon: m,
                    ...p
                } = e, v = t || !n || m ? "" : a, b = s(l().box, l()[`intent-${h}`], !t && l().check, !!t && l().dot, -1 === i && l().noOutline, c, n && l().checked, u && l().disabled, d && l().disableActiveStyles);
                return o.createElement("span", {
                    className: b,
                    ...p
        ...
        50238: (e, t, n) => {
            ...
            function r(e, t = []) {
                const [n, r] = (0, o.useState)(!1), a = (0, s.useFunctionalRefObject)(e);
        ...
        10772: (e, t, n) => {
            ...
            function v(e) {
                ...
                return o.createElement(m.ContextMenuItem, {
                    size: t,
                    jsxLabel: o.createElement("div", {
                        className: d()(p.loaderWrap, p[t])
                    }, o.createElement(h.Loader, {
                        className: p.loader
                    })),
                    noInteractive: !0,
            ...
            const w = (0, o.forwardRef)((function(e, t) {
                const {
                    className: n,
                    ...s
                } = e, [r, a] = (0, f.useRovingTabindexElement)(t);
                return o.createElement(m.ContextMenuItem, { ...s,
            ...
            class E extends o.PureComponent {
                constructor(e) {
                    super(e), this._itemRef = null, this._menuElementRef = o.createRef(), this._menuRef = null, this._handleClick = e => {
                            e.isDefaultPrevented() || this.state.disabled || (this._hasSubItems() ? this._showSubMenu() : (this.state.doNotCloseOnClick || (0, a.globalCloseMenu)(), this.props.action.execute(), this._trackEvent(), this.props.onExecute && this.props.onExecute(this.props.action)))
                        },
                        this._handleClickToolbox = () => {
                            ...
                            if (t) {
                                const {
                                    ...
                                    right: o,
                                    top: s
                                } = t.getBoundingClientRect(), r = document.documentElement.clientWidth, a = {
                                    x: n - e,
                                    y: s
                                }, i = {
                                    x: o,
                            ...
                            var e;
                            return null === (e = this.context) || void 0 === e ? void 0 : e.registerSubmenu(this.props.action.id, (e => (0, s.ensureNotNull)(this._itemRef).contains(e) || null !== this._menuElementRef.current && this._menuElementRef.current.contains(e)))
                ...
                render() {
                    ...
                    return this.state.loading ? o.createElement(v, {
            ...
            class E extends o.PureComponent {
                ...
                render() {
                    const {
                        ...
                        jsxLabel: v,
                        styledLabel: g
                    } = this.props, E = this.props.checkable && this.props.checkboxInput ? "label" : "div";
                    return o.createElement(o.Fragment, null, o.createElement("tr", { ...(0, m.filterDataProps)(this.props),
                        ...(0, m.filterAriaProps)(this.props),
                        className: s(this.props.className, l.item, !this.props.noInteractive && l.interactive, this.props.hovered && l.hovered, this.props.disabled && l.disabled, this.props.active && l.active, this.props.selected && l.selected, l[d]),
                        ...
                        onKeyDown: h
                    }, w && void 0 !== i && o.createElement("td", null, o.createElement(c.FavoriteButton, {
                        className: l.favourite,
                        isFilled: i,
                        onClick: this.props.onFavouriteClick
                    })), o.createElement("td", {
                        className: s(l.iconCell),
                        "data-icon-cell": !0
                    }, this._icon(l)), o.createElement("td", {
                        ...
                        key: n,
                        style: t
                    }, e))) : null != v ? v : p), this._toolbox(l), e && o.createElement("span", {
                        className: l.arrowIcon,
                        dangerouslySetInnerHTML: {
                            __html: b
                        },
                        "data-submenu-arrow": !0
                    }), !e && t && !a.CheckMobile.any() && o.createElement(u.Hint, {
                        className: s(r && l.invisibleHotkey),
                        text: t
                    }), !e && !t && n && o.createElement(u.Hint, {
                        text: n
                    })))), o.createElement("tr", {
                        className: l.subMenu
                ...
                _icon(e) {
                    if (this.props.checkable) {
                        if (this.props.checkboxInput) return o.createElement(r.CheckboxInput, {
                        ...
                        return this.props.icon ? o.createElement("span", {
                            className: e.icon,
                            dangerouslySetInnerHTML: {
                ...
                _toolbox(e) {
                    return this.props.toolbox ? o.createElement("span", {
                ...
                _renderToolboxContent() {
                    return this.props.toolbox && this.props.toolbox.type === d.ToolboxType.Delete ? o.createElement(l.RemoveButton, {
                        icon: p,
        ...
        91561: (e, t, n) => {
            ...
            function g(e) {
                ...
                return (0, o.useEffect)((() => {
                    ...
                    return n.onUpdate().subscribe(null, e), () => {
                        n.onUpdate().unsubscribe(null, e)
                    }
                }), []), o.createElement(v.ContextMenuItem, { ...s,
                    onClick: function(e) {
            ...
            function x(e) {
                const {
                    ...
                    parentAction: n,
                    closeNested: s
                } = e, r = !Boolean(n) && t.every((e => !Boolean("separator" !== e.type && (e.getState().icon || e.getState().checkable))));
                return o.createElement(w.EmptyIconsContext.Provider, {
                    value: r
                }, o.createElement("ul", null, n && o.createElement(o.Fragment, null, o.createElement(v.ContextMenuItem, {
                    ...
                    icon: E,
                    onClick: s
                }), o.createElement(p, null)), t.map((e => {
                    switch (e.type) {
                        case "action":
            ...
            class _ extends o.PureComponent {
                constructor(e) {
                    super(e), this._menuRef = o.createRef(), this._handleRequestUpdate = () => {
                        this.update()
                    }, this._handleClose = () => {
                ...
                render() {
                    ...
                    return e ? o.createElement(d.DrawerManager, null, o.createElement(c, {
                        keyCode: 27,
                        eventType: "keyup",
                        handler: this._handleClose
                    }), o.createElement(h.MatchMedia, {
                        rule: "screen and (max-width: 430px)"
                    }, (t => this._isDrawer(t) ? o.createElement(k.Provider, {
                        value: {
                            type: "drawer"
                        }
                    }, o.createElement(b.Drawer, {
                ...
                update() {
                    var e;
                    this._menuRef.current && this._menuRef.current.update(), this.props.isKeyboardEvent && (null === (e = this.props.menuElementReference) || void 0 === e ? void 0 : e.current) && document.activeElement === this.props.menuElementReference.current && (0, y.focusFirstMenuItem)(this.props.menuElementReference.current)
                }
                _isDrawer(e) {
        ...
        23829: (e, t, n) => {
            ...
            function p(e) {
                const {
                    ...
                    jsxLabel: N,
                    size: I = "normal"
                } = e, D = (0, o.useContext)(l.EmptyIconsContext), L = !!k.length;
                return s ? o.createElement("li", {
                    className: r()(t, m.item, m.loading, m[I])
                }, o.createElement(i.Loader, null)) : o.createElement("li", {
                    className: r()(t, m.item, m.interactive, n && m.title, f && m.disabled, p && m.hovered, v && m.active, D && m.emptyIcons, m[I]),
                    onClick: _
                    ...
                    key: n,
                    style: t
                }, e))) : null != N ? N : y), !!S && o.createElement(a.Icon, {
                    onClick: function() {
                        S && S.action()
                    },
                    className: m.remove,
                    icon: h
                }), !L && x && o.createElement(c.Hint, {
                    className: m.shortcut,
                    text: x
                }), L && o.createElement(a.Icon, {
                    className: m.nested,
                    icon: d
                }), M)
            }
        ...
        37558: (e, t, n) => {
            ...
            class r extends o.PureComponent {
                ...
                componentDidUpdate(e, t) {
                    !t.stack.length && this.state.stack.length && ((0, s.setFixedBodyState)(!0), this._isBodyFixed = !0), t.stack.length && !this.state.stack.length && this._isBodyFixed && ((0, s.setFixedBodyState)(!1), this._isBodyFixed = !1)
                }
                componentWillUnmount() {
        ...
        41590: (e, t, n) => {
            ...
            function m(e) {
                const {
                    ...
                    className: m,
                    theme: v = d
                } = e, b = (0, s.ensureNotNull)((0, o.useContext)(l.DrawerContext)), [f] = (0, o.useState)((() => (0, a.randomHash)())), g = (0, o.useRef)(null), w = (0, o.useContext)(c.CloseDelegateContext);
                return (0, o.useLayoutEffect)((() => ((0, s.ensureNotNull)(g.current).focus({
                    preventScroll: !0
                }), w.subscribe(b, n), b.addDrawer(f), () => {
                    b.removeDrawer(f), w.unsubscribe(b, n)
                })), []), o.createElement(i.Portal, null, o.createElement("div", {
                    ref: h,
                    className: r(d.wrap, d[`position${t}`])
                }, f === b.currentDrawer && o.createElement("div", {
        ...
        36189: (e, t, n) => {
            ...
            function d(e) {
                ...
                return s.createElement(a.Icon, { ...h,
        ...
        96040: (e, t, n) => {
            ...
            function c(e) {
                ...
                return s.createElement(a.Icon, { ...b,
                    "data-name": p,
        ...
        86656: (e, t, n) => {
            ...
            const c = (0, o.forwardRef)(((e, t) => {
                ...
                return (0, o.useImperativeHandle)(t, (() => c.current)), (0, o.useLayoutEffect)((() => {
                    if (a.CheckMobile.iOS()) return l++,
                        null !== c.current && (i ? 1 === l && (document.body.style.overscrollBehavior = "none") : (0, s.disableBodyScroll)(c.current, {
                            allowTouchMove: u(c)
                        })), () => {
                            l--, null !== c.current && (i ? 0 === l && (document.body.style.overscrollBehavior = "") : (0, s.enableBodyScroll)(c.current))
                        }
                }), []), o.createElement("div", {
                    ref: c,
                    ...r
